...
export default function Footer() {
  return (
    <footer className="bg-paper pb-8 pt-16 px-6 relative z-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_auto_auto] gap-12 md:gap-24">
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-hairline grid grid-cols-1 md:grid-cols-[1fr_auto_auto] gap-12 md:gap-24 items-center">
