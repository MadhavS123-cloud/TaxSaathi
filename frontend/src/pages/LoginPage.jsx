...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-paper font-sans text-ink">
      
      {/* LEFT COLUMN - Brand & Context */}
      <div className="w-full md:w-[55%] bg-taupe border-b md:border-b-0 md:border-r border-hairline relative flex flex-col justify-center p-8 md:p-16 lg:p-24 overflow-hidden">
      ...
      <div className="w-full md:w-[45%] bg-paper flex items-center justify-center p-8 lg:p-12">
